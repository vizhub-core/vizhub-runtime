...
describe("v4Build integration test", () => {
  it("should fully process the inline script test fixture", async () => {
    ...
    expect(html).not.toContain('import { main } from "./index.js";');
    ...
    expect(html).toContain('main(document.getElementById("viz-container"));');
    
    // Should preserve the HTML structure
    expect(html).toContain('<div id="viz-container"></div>');
