...
describe('getFileText', () => {
  ...
  it('should return null when content is undefined', () => {
    const result = getFileText(undefined as unknown as VizContent, 'index.html');
  ...
  it('should find the correct file when multiple files exist', () => {
    const mockVizContent: VizContent = {
      ...
      files: {
        ...
        'file2': { name: 'index.html', text: '<html>First</html>' },
        'file3': { name: 'script.js', text: 'console.log("Hello");' },
        'file4': { name: 'index.html', text: '<html>Second</html>' }
      }
    };
